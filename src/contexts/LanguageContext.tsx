...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    'portfolio.resourceCivilization.title': 'Le Canada, civilisation fondée sur les ressources au 21e siècle',
    'portfolio.resourceCivilization.desc': 'Analyse de la manière dont le développement historique du Canada en tant que système fondé sur les ressources continue de structurer sa position dans les structures mondiales émergentes définies par la transition énergétique, les matériaux stratégiques et la fragmentation géopolitique.',
