...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'portfolio.geopolitics.desc': 'An analytical brief on Canada\'s strategic positioning as global power dynamics shift away from post-Cold War unipolarity.',
    'portfolio.resources.title': 'Critical Minerals & the Energy Transition',
    'portfolio.resources.desc': 'Mapping the geopolitical implications of rare earth and critical mineral supply chains for Canada\'s resource sector.',
    'portfolio.technology.title': 'AI Governance & Digital Sovereignty',
    'portfolio.technology.desc': 'Examining how nations are navigating artificial intelligence regulation and the emerging landscape of digital power.',
    ...
    'portfolio.resourceCivilization.desc': 'An analytical essay examining how Canada’s historical development as a resource-based system shapes its position within emerging global structures defined by energy transition, strategic materials, and geopolitical fragmentation.',
