...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    'portfolio.geopolitics.desc': 'Analyse la manière dont l’évolution des rapports de force redéfinit la position du Canada dans un ordre mondial fragmenté.',
    ...
    'portfolio.resourceCivilization.desc': 'Analyse de la manière dont les dynamiques liées aux ressources structurent le développement du Canada et sa position au sein de systèmes mondiaux en évolution.',
