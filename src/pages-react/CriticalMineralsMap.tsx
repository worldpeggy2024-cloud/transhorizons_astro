...
import { MINERAL_DATA } from "@/data/criticalMineralsMapData";
import { CRITICAL_MINERALS_MAP_METADATA } from "@/data/criticalMineralsMapMetadata";
...
const GEO_URL = CRITICAL_MINERALS_MAP_METADATA.geometryPath;
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 pt-4 border-t border-slate-800 text-xs text-slate-600 space-y-1">
          ...
          <p className="text-slate-500">
            {lang === "en"
              ? `Dataset version ${CRITICAL_MINERALS_MAP_METADATA.datasetVersion} · Last updated ${CRITICAL_MINERALS_MAP_METADATA.lastUpdated} · Sources verified ${CRITICAL_MINERALS_MAP_METADATA.sourceLastVerified}`
              : `Version des donnees ${CRITICAL_MINERALS_MAP_METADATA.datasetVersion} · Derniere mise a jour ${CRITICAL_MINERALS_MAP_METADATA.lastUpdated} · Sources verifiees ${CRITICAL_MINERALS_MAP_METADATA.sourceLastVerified}`}
          </p>
