...
- Pointers are not content (added 2026-07-19 — the USA derivatives pass found the protestCapacity axis had no numerator because unrest was "tracked by ACLED" with no figure reported): citing a tracker, dataset, or dashboard without reporting a figure from it, with its year, is a gap wearing a citation. Report the figure, or enter the loop (targeted Pass A top-up + single-field rewrite).
