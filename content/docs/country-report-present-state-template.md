...
WRITING RULES:
- Situating sentences: Every peer opening and every field with a baseline meaning opens with a one-sentence situator before operational detail. The situator is orientation, not history — one short line. If it runs longer than a sentence, it has failed. The four REQUIRED openers are marked "OPENER (required)" in the sections below.
